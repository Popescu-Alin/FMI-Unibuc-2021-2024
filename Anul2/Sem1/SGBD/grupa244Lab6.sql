CREATE OR REPLACE TYPE subordonati_pva AS VARRAY(10) OF NUMBER(4);
/
CREATE TABLE manageri_pva (cod_mgr NUMBER(10),
 nume VARCHAR2(20),
 lista subordonati_pva);


SELECT * FROM manageri_pva;

DECLARE
    t subordonati_pva:=subordonati_pva(10,20,30);
    vLista manageri_pva%rowtype; 
    i INTEGER;
BEGIN 
    
    insert into manageri_pva 
    values(2,'cva2',NULL);
    ...
    DBMS_OUTPUT.PUT_LINE( vLista.cod_mgr );
